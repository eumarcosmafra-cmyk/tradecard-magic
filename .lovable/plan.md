...
O desenho descrito no seu texto já está, em quase tudo, refletido no site: a Copa ficou como área separada (só no menu), a home virou Pokémon/30 anos, a página de cadastro da pré-lista existe com limite de 1 CPF, e a retirada é presencial no quiosque do Palladium. O que o texto traz de novo são quatro pontos.

## 1. Prazo da pré-lista: até 25/09

Hoje o site fala do dia 25/09 como data do lançamento/abertura do quiosque, mas não diz que o cadastro fica aberto "até" essa data. Passar a deixar isso explícito na página de cadastro, no regulamento e na barra fixa: cadastros até 25/09.
...
## 4. Novos canais: TikTok Shop e Mercado Livre

Ainda não existem no site. Incluir os dois no rodapé (e na página de contato) assim que você tiver os links das lojas. Enquanto não houver link, deixo fora para não criar botão morto.

## Medição do funil

Os eventos de campanha → página → cadastro → quiosque já são registrados (visita, início de formulário, cadastro concluído, cadastro duplicado, clique em "como chegar" no quiosque, cliques nos botões de acesso antecipado). Complemento com dois eventos que faltam para fechar o funil do texto: clique para comprar no site (e-commerce) e clique nos canais externos (TikTok Shop / Mercado Livre), quando existirem.
...
- Canais externos: links no `Footer` + evento `outbound_channel_click` em `src/lib/analytics.ts`.
- Sem mudanças de banco de dados.

## Pendências suas

- Links do TikTok Shop e do Mercado Livre.
