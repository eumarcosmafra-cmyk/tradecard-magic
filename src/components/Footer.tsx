  ...
  <footer className="bg-card border-t border-border py-12">
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
        ...
        <div>
          <h5 className="font-display text-lg tracking-wider uppercase mb-4 text-secondary">Redes Sociais</h5>
          <ul className="space-y-2">
            <li>
              <a
                ...
                className="text-sm text-muted-foreground hover:text-secondary transition-colors font-body"
              >
                Instagram
              </a>
            </li>
