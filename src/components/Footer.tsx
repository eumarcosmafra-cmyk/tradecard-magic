    ...
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
        <div className="col-span-2 md:col-span-1">
          <span className="inline-flex items-center justify-center bg-ink rounded-lg px-3 py-1.5 border border-white/15 shadow-sm mb-4 w-fit">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground font-body">(41) 6347-5741</p>
