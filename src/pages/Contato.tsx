...
const Contato = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/554163475741?text=${text}`, "_blank");
    setSending(false);
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-4">
            <a
              href="https://wa.me/554163475741?text=Ol%C3%A1!%20Vim%20pelo%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20os%20produtos%20da%20Bella%20Figurinha%20%E2%9A%BD"
              target="_blank"
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-display text-lg text-foreground">(41) 6347-5741</p>
            ...
            <a href="tel:+554163475741" className="block bg-card border border-border rounded-2xl p-6 hover:border-primary/30 transition-colors">
              <div className="flex items-start gap-4">
