    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-28 pb-16 px-4 text-center">
        ...
        <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
          Nossas pop-up stores estarão em funcionamento de <strong className="text-foreground">01/05/2026</strong> até <strong className="text-foreground">19/07/2026</strong> nos principais shoppings do Sul e Sudeste do Brasil. Encontre a loja mais perto de você!
        </p>
      </section>
